...
config = {'pick':  ['blue block', 'yellow block', 'brown block', 'red block'],
          'place': ['red bowl', 'yellow bowl', 'blue bowl', 'brown bowl']}
