...
# Define and reset environment.
config = {'pick':  ['blue block', 'red block', 'yellow block'],
          'place': ['blue bowl', 'red bowl', 'yellow bowl']}
...
def translate_to_eng(user_input):
    ...
    chat = ChatOpenAI(model="gpt-3.5-turbo", openai_api_key="")
...
class CustomValid(LLM):
    ...
    def _call(
        ...
        llm_valid = ChatOpenAI(model="gpt-3.5-turbo", temperature=0)
