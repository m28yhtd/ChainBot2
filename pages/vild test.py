...
config = {'pick':  ['brown block', 'yellow block', 'red block', 'blue block', 'purple block'],
          'place': ['red bowl', 'blue bowl', 'yellow bowl', 'purple bowl', 'brown bowl']}
...
#CustomVLM에서 호출
initial_img = env.get_camera_image_top()
initial_img = np.flipud(initial_img.transpose(1, 0, 2))
imageio.imwrite('initial_state_top7.jpg', initial_img)

initial_img2 = env.get_camera_image()
imageio.imwrite('initial_state7.jpg', initial_img2)

initial_img_path2 = 'initial_state_SB/initial_state15.jpg'
...
def CustomVILD():
  ...
  found_objects, obj_x, obj_y = vild(initial_img_path2, category_name_string, vild_params, plot_on=True)
  vv_obj_x=[]
  vv_obj_y=[]
