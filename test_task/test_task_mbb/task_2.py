initial_prompt = "Place all blocks except the red ones on the matching color bowl."
...
found_objects = """objects = ['blue block', 'red block', 'yellow block', 'blue bowl', 'red bowl', 'yellow bowl']"""